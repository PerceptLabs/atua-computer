...
#if !defined(NDEBUG) || defined(__ATUA_BROWSER__)
/* Browser: enable logging even with NDEBUG so strace (-s) works.
   Assertions stay disabled (NDEBUG), only log output is enabled. */
